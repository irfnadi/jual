...
const config = {
    A187: '_Mr.057_',
    instagram: 'https://instagram.com/irfnadi_',
    nomer: 'wa.me/6282286425538',
    aktif: 'TERGANTUNG JARINGAN',
    youtube: 'https://youtube.com',
    whatsapp: 'https://chat.whatsapp.com/GfzA0gDBwqQJGptJgrKM3I',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code by IRFAN & MR057, Scan kode qr mu cok!`)
})
...
// client.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log(`${time}: Bot by ig:@irfnadi_`)

client.on('message-status-update', json => {
   const participant = json.participant ? ' (' + json.participant + ')' : ''
   console.log(`[ ${time} ] => bot by ig:@irfnadi_`)
})
